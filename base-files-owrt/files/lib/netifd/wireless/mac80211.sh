...
# source of this file is openwrt/package/kernel/mac80211/files/lib/netif/wireless/mac80211.sh
# we have done few modification on this file, which is required to bring wlan as per owrt way.
# Changes as follows:
# "Intel hostapd_wave package does not support -s option" hence this has to be updated
# enabling ht_coex didn't work with WAVE and hence had to be disabled
...
mac80211_hostapd_setup_base() {
	...
	[ -n "$ieee80211n" ] && {
		...
		set_default ht_coex 0
                ### FIXME OWRT 8.x - WLAN Integration
                ### enabling ht_coex didn't work with WAVE and hence had to be disabled
